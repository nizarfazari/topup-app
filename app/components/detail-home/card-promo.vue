...
<template>
 <div class="card bg-background-secondary w-full h-fit">
  ...
  <div class="flex flex-col md:flex-row gap-4 my-5">
   <label class="flex items-center gap-2 flex-1 rounded-md px-4 py-4 bg-background-secondary border border-secondary">
  ...
  <div class="flex">
   ...
   <div class="bg-background-primary p-3 w-full flex flex-col md:flex-row gap-5 justify-between">
    <div class="text-white space-y-1.5">
     <h1 class="text-base font-semibold font-poppins">
      Potongan 30%
     </h1>
    ...
    <div class="flex items-end justify-end">
     <button class="px-3 py-1 text-danger bg-danger/10 rounded-md cursor-pointer">
      Batalkan
     </button>
    </div>
   </div>
