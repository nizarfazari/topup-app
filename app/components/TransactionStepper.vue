...
import { PhWallet, PhArrowsClockwise, PhCheck } from "@phosphor-icons/vue";
...
<template>
  <div class="space-y-4">
    ...
    <div
      ...
      class="flex justify-center items-center gap-2 rounded-lg bg-info/20 p-3 text-sm text-white"
    >
    ...
    <div
      v-if="status === 'success'"
      class="flex justify-center items-center gap-2 rounded-lg bg-success/20 p-3 text-sm text-white"
    >
      <PhCheck size="18" />
      Transaksi Berhasil
    </div>
