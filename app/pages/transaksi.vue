...
const status = [
  ...
  { label: "Belum dibayar", value: 30 },
  { label: "Sedang diproses", value: 90 },
  { label: "Berhasil", value: 90 },
  { label: "Kadaluwarsa", value: 90 },
];
...
const transactions = [
  {
    ...
    image: "/images/transaksi/game.png",
    productName: "Mobile Legends",
    productDetail: "367 Diamonds",
    price: "Rp. 115.995",
  },
  {
    id: "12346",
  ...
  },
  {
    ...
    productDetail: "Blessing of the Welkin Moon",
    price: "Rp. 79.000",
  },
];
</script>
...
<template>
  <div class="custom-container mx-auto">
    <div
      class="flex flex-col md:flex-row md:items-center items-start justify-between gap-5"
    >
      <h1 class="text-white uppercase font-bold font-open-sans">
        Daftar Transaksi
      </h1>
    ...
    <section class="mt-5 flex flex-col gap-5">
      <TransaksiCard
        ...
        :product-detail="trx.productDetail"
