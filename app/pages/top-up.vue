 ...
 <div class="custom-container mx-auto">
  <div class="flex md:flex-row flex-col gap-5">
   <div class="card bg-background-secondary md:max-w-[367px] w-full text-white h-fit">
    ...
    <span class="text-[12px] text-[#00A389]  bg-[#00A3891A] px-2 py-1 rounded-full font-semibold  w-[66px] mx-auto ">
     Otomatis
    </span>
   ...
   <div class="flex flex-col gap-5">
    <div class="card bg-background-secondary w-full h-fit">
     ...
     <p class="text-[10px] text-[#B5B5B5] font-open-sans font-normal">Untuk mengetahui User ID Anda, silakan klik menu
      profile
      dibagian kiri atas
      pada menu utama game. User ID akan
      terlihat dibagian bawah Nama Karakter Game Anda. Silakan masukkan User ID Anda untuk menyelesaikan transaksi.
    ...
    <div class="card bg-background-secondary w-full h-fit">
     <div class="flex items-center gap-5">
      ...
      <h1 class="font-bold text-secondary text-xl md:text-2xl font-montserrat">Masukkan Nomor Whatsapp Atau Email</h1>
     </div>

     <p class="text-[#B5B5B5] text-[10px] font-normal font-open-sans my-5">Optional: Jika anda ingin mendapatkan bukti
     ...
     <div class="flex justify-between">
      ...
      <button class="rounded-full  bg-secondary  py-3 px-8 flex justify-center items-center gap-2 cursor-pointer"
       @click="open = true">
    ...
    <div class="card bg-background-secondary w-full h-fit">
     ...
     <div class="flex gap-4 my-5">
      ...
      <button
       class="shrink-0 rounded-full border-secondary border py-3 px-8 flex justify-center items-center gap-2 cursor-pointer">
     ...
     <div class="flex">
      ...
      <div class="bg-background-primary p-3 w-full flex justify-between">
